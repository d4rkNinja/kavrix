...
describe('CLI command shell', () => {
  ...
  it('limits the production bin catalog to commands with real static behavior', async () => {
    const publishedCommands =
      'version generate totp key init connect recover unlock lock status template group credential field note show copy reveal get sync backup device completion';
