 ...
 * no active settings because the current CLI requires explicit profile and
 * vault selection and does not automatically load this file.
 */
...
# Copy the examples you need into your terminal and keep profile and vault
# selection explicit. All protected paths must be inside a private directory.
#
...
#
# Credential commands keep the profile and opaque vault ID explicit:
