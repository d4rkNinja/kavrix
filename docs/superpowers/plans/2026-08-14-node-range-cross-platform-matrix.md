...
- [x] **Step 1: Replace the narrowed verification matrix**
...
- [x] **Step 2: Replace the Windows-only runtime matrix**
...
- [x] **Step 1: Add exact matrix-set assertions**
...
- [x] **Step 1: Record local evidence without overstating completion**
...
- [x] **Step 2: Run formatting, build, and type checks**
